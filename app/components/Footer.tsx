...
export default function Footer() {
  return (
    <footer className=" w-full text-white py-20">
      <div className="flex flex-col gap-10 md:flex-row items-center justify-between md:px-40 m-0">
        <div className="w-full flex md:items-start md:justify-center items-center flex-col gap-10 md:w-1/2 p-0 m-0">
          <div className="flex items-center font-roboto font-black mb-4">
            <img src="/hc_logo.svg" alt="Logo" className="" />
            <a id="hc" className="inline-block p-2 text-2xl">
          ...
          <div className="flex items-center gap-4">
            <div className="social-button">
              ...
              >
                ...
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-violet-400 rounded-full">
                  <a href="https://www.instagram.com/hackclubvitc?igsh=a3phNW02ZXRhcW41">
                    <svg
            ...
            <div className="social-button">
              ...
              >
                ...
                <div className="icon relative z-10 w-full h-full flex items-center justify-center duration-100 border-2 group-hover:border-white border-black rounded-full">
                  <a href="https://github.com/HackclubVIT">
                    <svg
                      height="24"
                      width="24"
                      viewBox="0 0 24 24"
        ...
        <div className="text-center flex flex-col md:items-end font-roboto font-medium text-base p-4">
          <p className="mb-2">
            <a
